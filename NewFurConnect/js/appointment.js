...
function validateAppointmentForm(data) {
  ...
  if (
    ...
    alert("Id filled is not filled");
    return false;
  } else if (!data.ownerName ||) {
    alert("Please fill the owner name field.")
  } else if (!data.contactNumber ||) {
    alert("Please fill the contact number filled.")
    return false;
  } else if (!data.email ||) {
    alert("Please fill the email field.")
    return false;
  } else if (!data.petName ||) {
    alert("Please fill your pet name") 
    return false;
  } else if (!data.petSpecies ||) {
    alert("Please fill your pet species") 
    return false;
  } else if (!data.breed ||) {
    alert("Please fill the breed field")
    return false;
  } else if (!data.age ||) {
    alert("Please fill your pet age field.") 
    return false;
  } else if (!data.ageUnit ||) {
    alert("Please fill indicate your pet years/mos")
    return false;
  } else if (!data.gender ||) {
    alert("Please fill the gender of your pet") 
      return false;
  } else if (!data.weight ||) {
    alert("Please fill the weight of your pet") 
    return false;
  } else if (!data.appointmentDate ||) {
    alert("Please fill the appointment date")
  } else if (!data.appointmentTime ||) {
    alert("Please fill the time of your appointment") 
    return false;
  } else if (!data.appointmentType) {
    alert("Please fill what type of appointment.")
    return false;
  }
